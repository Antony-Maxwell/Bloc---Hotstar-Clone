...
mixin _$SearchState {
  ...
  List<Trendings> get searchIdle => throw _privateConstructorUsedError;
...
class _$SearchStateCopyWithImpl<$Res, $Val extends SearchState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      searchIdle: null == searchIdle
          ? _value.searchIdle
          : searchIdle // ignore: cast_nullable_to_non_nullable
              as List<Trendings>,
...
class _$SearchStateImpl implements _SearchState {
  const _$SearchStateImpl(
      ...
      required final List<Trendings> searchIdle,
      required this.isLoading,
      required this.isError})
      : _searchResultList = searchResultList,
        _searchIdle = searchIdle;
  ...
  final List<Trendings> _searchIdle;
  @override
  List<Trendings> get searchIdle {
  ...
  @override
  String toString() {
    return 'SearchState(searchResultList: $searchResultList, searchIdle: $searchIdle, isLoading: $isLoading, isError: $isError)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._searchIdle, _searchIdle) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_searchIdle),
      isLoading,
      isError);
